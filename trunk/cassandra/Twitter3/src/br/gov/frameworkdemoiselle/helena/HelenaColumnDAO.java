...
public abstract class HelenaColumnDAO<T> extends AbstractHelenaDAO<T> {

	private static Logger log = Logger.getLogger(HelenaColumnDAO.class);
	...
	public HelenaColumnDAO() {
        ...
        log.debug("Instantiating HelenaColumnDAO with " + clz.getSimpleName());
